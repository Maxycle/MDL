...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "MDL_production"

	 config.frontend_url = ENV['FRONTEND_URL'] || 'https://libertarien.net'

	 config.action_mailer.default_url_options = { host: ENV['MAILER_HOST'] || 'libertarien.net' }
