<template>
	<Container>
		<div class="flex justify-center w-full bg-gradient-to-b from-[#14191d] to-blueLogoLight">
			<div class="w-2/3 md:w-1/3 text-center min-h-screen">
					...
					<form @submit.prevent="signIn"
						...
						<div class="text-center py-3">
							<router-link :to="{ name: 'ForgotPassword' }"
								class="text-yellowLogo hover:text-[#e65edf] text-sm transition-colors duration-300">
								Mot de passe oublié?
							</router-link>
						</div>
					</form>
